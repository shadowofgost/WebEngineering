...
from django.db.models import Model, CharField, IntegerField, SmallIntegerField, BigAutoField
...
class DepartmentModel(Model):
    ...
    id_parent = IntegerField(
        default=0, null=True, db_column='ID_Parent',blank=True)
    name = CharField(default='0', null=True,
                            db_column='Name', max_length=32,blank = True)
    timeupdate = IntegerField(
        default=0, null=True, db_column='TimeUpdate',blank = True)
    idmanager = IntegerField(
        default=0, null=True, db_column='IdManager',blank = True)
    ...
    bakc_up1 = CharField(
        default='0', null=True,  max_length=254, blank=True)
