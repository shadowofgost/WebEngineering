...
class TcyEquipment(Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            Index(fields=["login"], name="login_index"),
            Index(fields=["link"], name="link_index"),
            Index(fields=["state"], name="state_index"),
            Index(fields=["class_field"], name="class_field_index"),
        ]
        ordering = ["id", "name"]
