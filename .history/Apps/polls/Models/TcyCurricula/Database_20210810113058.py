from django.db.models import Model, CharField, ForeignKey, CASCADE,  IntegerField, ForeignKey, SmallIntegerField, Index, BigAutoField
...
class CurriculaModel(Model):
    id = BigAutoField(db_column='ID',
                      primary_key=True, unique=True, blank=True)
    name = CharField(default='0', null=True,
                     db_column='Name', max_length=32, blank=True)
    timebegin = IntegerField(default=0, null=True,
                             db_column='TimeBegin', blank=True)
    timeend = IntegerField(
        default=0, null=True, db_column='TimeEnd', blank=True)
    ...
    attr = SmallIntegerField(
        default=2, null=True, db_column='Attr', blank=True)
    ...
    charge = SmallIntegerField(
        default=0, null=True, db_column='Charge', blank=True)
    ...
    '''pwcontinuous = SmallIntegerField(default=1, null=True,
                                     db_column='PwContinuous', blank=True,choices = pwcontinuous_choices)'''
    pwcontinuous = SmallIntegerField(default=1, null=True,
    ...
    '''pwdirection = SmallIntegerField(default=1, null=True,
                                    db_column='PwDirection', blank=True,choices = pwdirection_choices)'''
    pwdirection = SmallIntegerField(default=1, null=True,
    ...
    dooropen = SmallIntegerField(
        default=0, null=True, db_column='DoorOpen', blank=True)
    ######dooropen匹配的用户刷卡是否开门，0开门，1不开门######
    timebegincheckbegin = IntegerField(default=0, null=True,
                                       db_column='TimeBeginCheckBegin', blank=True)
    ######0代表无效######
    timebegincheckend = IntegerField(default=0, null=True,
                                     db_column='TimeBeginCheckEnd', blank=True)
    ######0代表无效######
    timeendcheckbegin = IntegerField(default=0, null=True,
                                     db_column='TimeEndCheckBegin', blank=True)
    ######0代表无效######
    timeendcheckend = IntegerField(default=0, null=True,
                                   db_column='TimeEndCheckEnd', blank=True)
    ######0代表无效######
    rangeusers = CharField(default='0', null=True,
                           db_column='RangeUsers', max_length=1024, blank=True)
    listdepts = CharField(default='0', null=True,
    ...
    mapuser2equ = CharField(default='0', null=True,
                            db_column='MapUser2Equ', max_length=1024, blank=True)
    aboutspeaker = CharField(default='0', null=True,
    ...
    imark = SmallIntegerField(default=1, null=True,
                              db_column='IMark', blank=True)
    bakc_up1 = CharField(default='0', null=True,
