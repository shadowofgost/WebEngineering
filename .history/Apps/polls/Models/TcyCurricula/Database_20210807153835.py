...
class CurriculaModel(Model):
    ...
    id_location = ForeignKey(
        TCylocation, to_field="id", on_delete=CASCADE, db_column='ID_Location', related_name='curricula_related_to_location'
    )
    id_speaker = ForeignKey(
        UserModel, to_field="id", on_delete=CASCADE, db_column='ID_Speaker', related_name='curricula_related_to_user_speaker'
    )
    ...
    idmanager = ForeignKey(
        UserModel, to_field="id", on_delete=CASCADE, db_column='IdManager', related_name='curricula_related_to_user'
    )
