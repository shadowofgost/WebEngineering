...
class LocationModel(Model):
    id = BigAutoField(db_column="ID", blank=True, primary_key=True)
...
class LocationExtensionModel(Model):
    ...
    attr = SmallIntegerField(default=1, null=True, db_column="Attr", blank=True)
    datebegin = IntegerField(default=1, null=True, db_column="DateBegin", blank=True)
    dateend = IntegerField(default=1, null=True, db_column="DateEnd", blank=True)
    moderun = IntegerField(default=1, null=True, db_column="ModeRun", blank=True)
    modeshangji = IntegerField(
        default=1, null=True, db_column="ModeShangJi", blank=True
    )
    enabledelaycharged = IntegerField(
        default=1, null=True, db_column="EnableDelayCharged", blank=True
    )
    delaycharged = IntegerField(
        default=1, null=True, db_column="DelayCharged", blank=True
    )
    enablelimityue_sj = IntegerField(
        default=1, null=True, db_column="EnableLimitYuE_SJ", blank=True
    )
    limityue_sj = IntegerField(
        default=1, null=True, db_column="LimitYuE_SJ", blank=True
    )
    enablelimityue_xj = IntegerField(
        default=1, null=True, db_column="EnableLimitYuE_XJ", blank=True
    )
    limityue_xj = IntegerField(
        default=1, null=True, db_column="LimitYuE_XJ", blank=True
    )
    enablelimittime_xj = IntegerField(
        default=1, null=True, db_column="EnableLimitTime_XJ", blank=True
    )
    limittime_xj = IntegerField(
        default=1, null=True, db_column="LimitTime_XJ", blank=True
    )
    enablewarnyue = IntegerField(
        default=1, null=True, db_column="EnableWarnYuE", blank=True
    )
    warnyue = IntegerField(default=1, null=True, db_column="WarnYuE", blank=True)
    enablewarntime = IntegerField(
        default=1, null=True, db_column="EnableWarnTime", blank=True
    )
    warntime = IntegerField(default=1, null=True, db_column="WarnTime", blank=True)
    enablemincost = IntegerField(
        default=1, null=True, db_column="EnableMinCost", blank=True
    )
    mincost = IntegerField(default=1, null=True, db_column="MinCost", blank=True)
    price = IntegerField(default=1, null=True, db_column="Price", blank=True)
    priceminute = IntegerField(
        default=1, null=True, db_column="PriceMinute", blank=True
    )
    getequname = IntegerField(default=1, null=True, db_column="GetEquName", blank=True)
    getequip = IntegerField(default=1, null=True, db_column="GetEquIp", blank=True)
    getequmac = IntegerField(default=1, null=True, db_column="GetEquMac", blank=True)
