...
from rest_framework.serializers import ModelSerializer,CharField,IntegerField,ModelField,SlugRelatedField
from .Database import UserModel, UserExtensionModel
class UserModelSerializer(ModelSerializer):
    department_name = SlugRelatedField(slug_field='name',queryset=UserExtensionModel.objects.all(),source='dept_id')
    class Meta:
        model = UserModel
        field = '__all__'
