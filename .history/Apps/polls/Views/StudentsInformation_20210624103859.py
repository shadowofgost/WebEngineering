...
class StudentsInformation(APIView):
    ...
    def get(self, request, args, session):
        ...
        data_user = models.TCyuser.objects.filter(attr=4).values('id', 'nocard', 'nouser', 'name', 'psw', 'deptid__name', 'sex', 'attr', 'timeupdate', 'userex_related_to_user_information__rem',
