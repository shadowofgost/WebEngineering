...
class AttendanceInformationClass(AttendanceInformation):
    ...
    @swagger_auto_schema(
        ...
        security=None,
        responses={
            200: AttendanceInformationClass_get_responses_success,
    ...
    @swagger_auto_schema(
        ...
        security=None,
        responses={
            201: AttendanceInformationClass_post_responses_success,
            400: AttendanceInformationClass_post_responses_fail,
        },
        tags=None,
    )
    @get_request_args
