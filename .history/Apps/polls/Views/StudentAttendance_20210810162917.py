...
class StudentAttendance(APIView):
    ...
    StudentAttendanceInformation_get_responses_fail = Response(
        ...
        examples={"error_code": 1, "message": "获取成功"},
    )
    ...
    @swagger_auto_schema(
        request_body=None,
        manual_parameters=[
            StudentInformation_get_parammeter,
            page_get_parammeter,
    ...
    @swagger_auto_schema(
        ...
        security=None,
        responses={
            201: StudentAttendanceInformation_post_responses_success,
            400: StudentAttendanceInformation_post_responses_fail,
        },
        tags=None,
    )
    @get_request_args
