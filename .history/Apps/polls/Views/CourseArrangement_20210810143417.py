...
class CourseArrangement(APIView):
    ...
    def put(self, request, args, session):
        ...
        if (
            isinstance(variable_name["id_location__name"], int)
            and isinstance(variable_name["id_speaker__name"], int)
            and isinstance(variable_name["id_curricula__name"], int)
        ):
    ...
    @swagger_auto_schema(
        request_body=CourseArrangement_patch_request_body,
        manual_parameters=None,
        operation_id=None,
    ...
    def patch(self, request, args, session):
        ...
        if (
            ...
            and isinstance(args["id_curricula__name"], int)
