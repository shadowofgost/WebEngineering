...
class AttendanceInformation(APIView):
    ...
    def post(self, request, args, session):
        ...
        if input_string == None:
            ...
            if isinstance(test_input, int):
                data_equipment = list(RunningAccountModel.objects.filter(
                    Q(id=test_input) |
    ...
    def put(self, request, args, session):
        ...
        try:
            ...
            param2_object = CoursePlanModel.objects.get(
    ...
    def patch(self, request, args, session):
        ...
        data_equipment_initial = list(
            RunningAccountModel.objects.filter(id=id_equipment).values('id', 'id_user', 'param2', 'idmanager', 'timeupdate', 'param1', 'time', 'money', 'type_field'))
