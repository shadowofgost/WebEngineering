...
class TCydept(models.Model):
    ...
    id_parent = models.IntegerField( default = 1, null =True , db_column='ID_Parent')
    name = models.CharField(default = '1', null =True ,  db_column='Name', max_length=32)
    timeupdate = models.IntegerField( default = 1, null =True , db_column='TimeUpdate')
    idmanager = models.IntegerField( default = 1, null =True , db_column='IdManager')
    imark = models.IntegerField( default = 1, null =True , db_column='IMark')
    bakc_up1 = models.CharField(default = '1', null =True ,  max_length=254, blank=True)
...
class TCyuser(models.Model):
    id = models.IntegerField( default = 1, db_column='ID', primary_key=True)
    nocard = models.CharField(default = '1', null =True ,  db_column='Nocard', max_length=32)
    nouser = models.CharField(default = '1', null =True ,  db_column='NoUser', max_length=32)
    name = models.CharField(default = '1', null =True ,  db_column='Name', max_length=32)
    psw = models.CharField(default = '1', null =True ,  db_column='Psw', max_length=32)
    deptid = models. ForeignKey(
        TCydept, to_field="id", on_delete=models.CASCADE,  db_column='Deptid',related_name='related_to_department')
    sex = models.IntegerField( default = 1, null =True , db_column='Sex')
    ##########sex 的值只能为0（女）或者1（男）##########
    attr = models.IntegerField( default = 1, null =True , db_column='Attr')
    ##########attr 用户管理权限， 0普通用户、1管理员、2超级管理员（可对管理员进行管理）##########
    attrjf = models.IntegerField( default = 1, null =True , db_column='AttrJf')
    ...
    localid = models.CharField(default = '1', null =True ,  db_column='LocalID', max_length=1024)
    imark = models.IntegerField( default = 1, null =True , db_column='IMark')
...
class TCylocation(models.Model):
    id = models.IntegerField( default = 1, db_column='ID', blank=True, primary_key=True)
...
class TCycurricula(models.Model):
    ...
    timeend = models.IntegerField( default = 1, null =True , db_column='TimeEnd', blank=True)
    ...
    attr = models.IntegerField( default = 1, null =True , db_column='Attr', blank=True)
    #####attr1代表实验类型、2代表普通上课类型、3讲座考勤类型，必须有值实验类型：奇数刷卡派位，偶数刷卡下机，并记录派位编号上课考勤类型：刷卡记录刷卡机编号讲座考勤类型：刷卡记录刷卡机编号######
    charge = models.IntegerField( default = 1, null =True , db_column='Charge', blank=True)
    ######charge免费0、收费1、开放2，必须有值######
    pwaccess = models.IntegerField( default = 1, null =True , db_column='PwAccess', blank=True)
    ######pwaccess不派位0、刷卡派位1（派位指用户刷卡时系统指定座位）######
    pwcontinuous = models.IntegerField( default = 1, null =True ,
        db_column='PwContinuous', blank=True)
    ######pwcontinuous连续派位0、随机派位1######
    pwdirection = models.IntegerField( default = 1, null =True ,
        db_column='PwDirection', blank=True)
    ######pwdirection顺序派位0、逆序派位1（当设置为随机派位时本功能无效）#######
    dooropen = models.IntegerField( default = 1, null =True , db_column='DoorOpen', blank=True)
...
class TCyplan(models.Model):
    id = models.IntegerField( default = 1,  db_column='ID', primary_key=True, blank=True)
...
class TCyequipment(models.Model):
    ...
    id_location_sn = models.IntegerField( default = 1, null =True ,
    ...
    state = models.IntegerField( default = 1, null =True , db_column='State', blank=True)
    ########state设备状态，0：正常空闲、1：故障、2：其它、3：正常使用中、4开放########
    login = models.IntegerField( default = 1, null =True , db_column='Login', blank=True)
    ########login登录状态，0：未登录、1：已经登录########
    link = models.IntegerField( default = 1, null =True , db_column='Link', blank=True)
    # link网络状态，0：脱机、1：在线，######## Field renamed because it was a Python reserved word.
    class_field = models.IntegerField( default = 1, null =True , db_column='Class', blank=True)
    ...
    type_field = models.IntegerField( default = 1, null =True , db_column='Type', blank=True)
    timedelay = models.IntegerField( default = 1, null =True ,
        db_column='TimeDelay', blank=True)
    keycancel = models.IntegerField( default = 1, null =True ,
        db_column='KeyCancel', blank=True)
    keyOk = models.IntegerField( default = 1, null =True , db_column='KeyOk', blank=True)
    keydel = models.IntegerField( default = 1, null =True , db_column='KeyDel', blank=True)
    keyf1 = models.IntegerField( default = 1, null =True , db_column='KeyF1', blank=True)
    onall = models.IntegerField( default = 1, null =True , db_column='OnAll', blank=True)
    rangeequs = models.CharField(default = '1', null =True ,
...
class TCyTableInfo(models.Model):
    id = models.IntegerField( default = 1,  db_column='ID', primary_key=True)
    name = models.CharField(default = '1', null =True ,  db_column='Name', max_length=50)
    nametable = models.CharField(default = '1', null =True ,  db_column='NameTable', max_length=50)
    timeupdate = models.IntegerField( default = 1, null =True , db_column='TimeUpdate')
    idmanager = models. ForeignKey(
        TCyuser, to_field="id", on_delete=models.CASCADE, db_column='IdManager', related_name='kaoqin_related_to_user'
        )
    imark = models.IntegerField( default = 1, null =True , db_column='IMark')
    back_up1 = models.CharField(default = '1', null =True ,  max_length=254, blank=True)
    back_up2 = models.IntegerField( default = 1, null =True , blank=True)
    back_up3 = models.IntegerField( default = 1, null =True )
...
class TCylocationex(models.Model):
    ...
    dateend = models.IntegerField( default = 1, null =True , db_column='DateEnd', blank=True)
    moderun = models.IntegerField( default = 1, null =True , db_column='ModeRun', blank=True)
    ...
    warnyue = models.IntegerField( default = 1, null =True , db_column='WarnYuE', blank=True)
    enablewarntime = models.IntegerField( default = 1, null =True ,
        db_column='EnableWarnTime', blank=True)
    warntime = models.IntegerField( default = 1, null =True , db_column='WarnTime', blank=True)
    enablemincost = models.IntegerField( default = 1, null =True ,
        db_column='EnableMinCost', blank=True)
    mincost = models.IntegerField( default = 1, null =True , db_column='MinCost', blank=True)
    price = models.IntegerField( default = 1, null =True , db_column='Price', blank=True)
    ...
    getequip = models.IntegerField( default = 1, null =True , db_column='GetEquIp', blank=True)
...
class TCymmx(models.Model):
    id = models.IntegerField( default = 1,  db_column='ID', blank=True, primary_key=True)
    id_data = models.IntegerField( default = 1, null =True , db_column='ID_Data', blank=True)
    id_type = models.IntegerField( default = 1, null =True , db_column='ID_Type', blank=True)
...
class TCyuserex(models.Model):
    ...
    photo = models.BinaryField(db_column='Photo', blank=True)
    timeupdate = models.IntegerField( default = 1, null =True ,
        db_column='TimeUpdate',blank=True)
    idmanager = models.ForeignKey(
        TCyuser, to_field="id", on_delete=models.CASCADE, db_column='IdManager', related_name='userex_related_to_user')
    imark = models.IntegerField( default = 1, null =True , db_column='IMark')
    photo_dataf = models.TextField(
        db_column='Photo_dataF', blank=True, null = True)
    back_up1 = models.CharField(default = '1', null =True ,
        max_length=254, blank=True)
    back_up2 = models.IntegerField( default = 1, null =True , blank=True)
    back_up3 = models.IntegerField( default = 1, null =True , blank=True)
