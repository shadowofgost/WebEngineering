    ...
    def post(self, request, args, session):
        ...
        if input_string == None:
            ...
            if isinstance(test_input, int):
                ...
                ).values('id', 'id__nocard', 'id__nouser', 'id__name', 'id__psw', 'id__deptid__name', 'id__sex', 'id__attr', 'id__timeupdate', 'timeupdate', 'idmanager__name', 'rem', 'id__localid').distinct()
            else:
                data_user_information = models.TCyuserex.objects.filter(
                    Q(id__name__icontains=input_string) |
                    Q(id__psw__icontains=input_string) |
                    Q(id__deptid__name=input_string) |
                    Q(idmanager__name=input_string) |
                    Q(rem=input_string), attr=user_group_id
                ).values('id', 'id__nocard', 'id__nouser', 'id__name', 'id__psw', 'id__deptid__name', 'id__sex', 'id__attr', 'id__timeupdate', 'timeupdate', 'idmanager__name', 'rem',  'id__localid').distinct()
