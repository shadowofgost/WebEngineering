...
from .Public import responses_success, responses_fail, get_request_args, post_search, content_type_tmp, data_total_response, post_success, post_error, patch_success, patch_error, put_success, put_error, data_base_error_specific, id_error, data_attendance, delete_schema
        ...
        if input_string == None:
            ...
            if isinstance(test_input, int):
                ...
                data_equipment = list(models.TCyRunningaccount.objects.filter(
                    ...
                    | Q(param2__id_curricula__name__icontains=input_string)
